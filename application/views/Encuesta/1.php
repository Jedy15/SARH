							...
							<div class="form-group">
								...
								<select class="form-control select2" style="width: 100%;" name="Entidad_Nacimiento" id="Entidad_Nacimiento" required="">
									...
									<?php foreach ($estado as $item):
										if($item->ID == set_value('Entidad_Nacimiento',@$datos_reg[0]->Entidad_Nacimiento)){?>
											<option value="<?php echo $item->ID;?>" selected="selected"><?php echo $item->ENTIDAD_FEDERATIVA;?></option>
										<?php } else { ?>
