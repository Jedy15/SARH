	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content">
				...
				<?php echo form_open('Administrar/NuevoPrograma', 'onsubmit = Block($(this));'); ?>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" autofocus="" required="" name="Programa" placeholder="Ingrese Nombre">
										</div>
										<div class="form-group">
				...
				<?php echo form_open('Administrar/EditarPrograma', 'onsubmit = Block($(this));'); ?>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Programa2">Nombre</label>
											<input type="text" class="form-control" name="Programa2" id="Programa2" placeholder="Ingrese Nombre" required="">
											<input type="hidden" class="form-control" name="IdPrograma" id="IdPrograma">
										</div>
										<div class="form-group">
	...
	<script type="text/javascript">
		...
		var listar=function(){
			var table = $('#example').DataTable({
				ajax: {
					url: '<?php echo base_url();?>Administrar/CargarTablaPrograma',
					type: 'POST'
				},
