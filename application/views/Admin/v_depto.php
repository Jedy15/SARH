...
<head>
	...
	<title>SRH2018 | Departamentos</title>
						...
						<div class="box box-primary">
							...
							<div class="box-body table-responsive">
								<table id="example1" class="table table-hove table-bordered table-striped">
									...
									foreach ($reg as $l1){ ?>
										<tr>
											<td><?php echo $l1->IdDepto ?></td>
											<td><?php echo $l1->DEPARTAMENTO ?></td>
											<td><?php echo $l1->Nota ?></td>		
											<?php $create=strtotime($l1->Fecha);
											$l1->Fecha = date('d',$create)." de ".$meses[date('n',$create)-1]. " del ".date('Y g:i a',$create);?>
											<td><?php echo $l1->Fecha ?></td>
											<td><a id="editar" href=" <?php echo base_url().'administrar/EditarDepto/'.$l1->IdDepto ?>" class="btn btn-block btn-success btn-xs">Editar</a></td>
										</tr>
									<?php } ?>				
								</tbody>
								<tfoot>
	...
	<div class="modal modal-info fade" id="modal-info">
		<div class="modal-dialog">
			<div class="modal-content">
				<?php echo form_open('Administrar/AltaDepto'); ?>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Alta de Departamento</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label for="DEPARTAMENTO">Nombre de Departamento</label>
							<input type="text" class="form-control" required name="DEPARTAMENTO" id="DEPARTAMENTO" placeholder="Nombre del departamento" maxlength="45" size="45">
						</div>
						<div class="form-group">
		...
		<div class="modal modal-success fade" id="modalEdit">
			<div class="modal-dialog">
				<div class="modal-content">
					<?php echo form_open('Administrar/EditarDepto/'.$Depto[0]->IdDepto); ?>
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title">Editar Departamento N° <?php echo $Depto[0]->IdDepto ?></h4>
						</div>
						<div class="modal-body" id="FrmEditar">
							<div class="form-group">
								<label for="DEPARTAMENTO">Nombre de Departamento</label>
								<input type="text" class="form-control" required name="DEPARTAMENTO" id="DEPARTAMENTO" placeholder="Medicos Especialistas Ginecologos" maxlength="50" size="50" value="<?php echo set_value('DEPARTAMENTO',@$Depto[0]->DEPARTAMENTO); ?>">
							</div>
							<div class="form-group">
								<label for="Nota">Descripción</label>
								<textarea class="form-control" rows="3" name="Nota" id="Nota" placeholder="Descripción del Grupo"><?php echo set_value('Nota',@$Depto[0]->Nota); ?></textarea>
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancelar</button>
		...
		<script>
			...
			<?php if ($this->uri->segment(2)== 'EditarDepto' ){  ?>
