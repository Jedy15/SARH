	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content">
					...
					<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-header">
								...
								<h3 class="box-title">Sindicatos</h3>
				...
				<?php echo form_open('Administrar/NuevoSeccion', 'onsubmit = Block($(this));'); ?>
					...
					<div class="modal-dialog">						
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Nuevo Sindicato</h4>
							</div>
							<div class="modal-body">								
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Seccion">Nombre de Sección</label>
											<input type="text" class="form-control" autofocus="" required="" name="Seccion" placeholder="Ingrese Nombre">
										</div>
										<div class="form-group">
				...
				<?php echo form_open('Administrar/EditarSeccion', 'onsubmit = Block($(this));'); ?>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Seccion2">Nombre de Sección</label>
											<input type="text" class="form-control" name="Seccion2" id="Seccion2" placeholder="Ingrese Nombre" required="">
											<input type="hidden" class="form-control" name="IdSeccion" id="IdSeccion">
										</div>
										<div class="form-group">
	...
	<script type="text/javascript">
		...
		var listar=function(){
			var table = $('#example').DataTable({
				ajax: {
					url: '<?php echo base_url();?>Administrar/CargarTablaSindicato',
					type: 'POST'
				},
