	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
					...
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Lista de Funciones</h3>
								<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modal-nuevo"> <i class="fa fa-plus"></i> Funciones</button>
							</div>
				...
				<!-- /.row -->
				<?php echo form_open('Administrar/NuevaFuncion'); ?>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Funcion">Nombre de la Función</label>
											<input type="text" class="form-control" name="Funcion" id="Funcion" placeholder="Ingrese Función" required="">
										</div>
										<div class="form-group">
											<label for="nota">Comentario</label>
											<input type="text" class="form-control" required="" name="nota" id="nota" placeholder="Agregue algun comentario">
										</div>									
									</div>
								</div>
							</div>
				...
				<?php echo form_open('Administrar/EditarFuncion', 'id="FrmEditar"'); ?>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<input type="hidden" class="form-control" name="IdFuncion" id="IdFuncion">
											<label for="Funcion">Nombre de la Función</label>
											<input type="text" class="form-control" name="Funcion" id="Funcion" placeholder="Ingrese Nombre" required="">
										</div>
										<div class="form-group">
											<label for="nota">Comentario</label>
											<input type="text" class="form-control" required="" name="nota" id="nota" placeholder="Agregue algun comentario">
				...
				<?php echo form_open('Administrar/EliminarFuncion', 'id="FrmEliminar"'); ?>
  ...
  <script>
  	...
  	var listar=function(){
  		var table = $('#example').DataTable({
  			ajax: {
  				url: '<?php echo base_url();?>Administrar/CargarFunciones',
  				type: 'POST'
  			},
  			columns: [
  			{ "data": "IdFuncion" },
  	...
  	var obtener_data_editar = function(tbody, table){
  		$(tbody).on('click', 'button.editar', function() {
  			...
  			$('#FrmEditar #Funcion').val(data.Funcion);
  			$('#FrmEditar #nota').val(data.nota);
  			$('#FrmEditar #IdFuncion').val(data.IdFuncion);
  		});
  	}
  	...
  	var obtener_id_eliminar = function(tbody, table){
  		$(tbody).on('click', 'button.eliminar', function() {
  			var data =table.row($(this).parents("tr")).data();
  			$('#FrmEliminar #IdFuncion').val(data.IdFuncion);
  		});
  	}
