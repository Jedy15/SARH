...
<head>
	...
	<title> SARH | Subsección Sindical</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content">
					...
					<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-header">
								...
								<h3 class="box-title">Subsección Sindical</h3>
								<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modal-nuevo"><i class="fa fa-plus"></i> Nuevo</button>
							</div>
				...
				<?php echo form_open('Administrar/NuevoSubseccion', 'onsubmit = Block($(this));'); ?>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Subseccion">Nombre de la Subsección</label>
											<input type="text" class="form-control" autofocus="" required="" name="Subseccion" placeholder="Ingrese Nombre">
										</div>
										<div class="form-group">
											<label for="IdSeccion">Sección</label>
											<select class="form-control select2" style="width: 100%;" required="" name="IdSeccion" id="IdSeccion">
												<option></option>
											</select>
										</div>
										<div class="form-group">
											<label for="Nota">Nota</label>
											<input type="text" class="form-control" name="Nota" placeholder="Comentario">
										</div>
									</div>								
								</div>
							</div>
				...
				<?php echo form_open('Administrar/EditarSubseccion', 'onsubmit = Block($(this));'); ?>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group">
											<label for="Subseccion2">Nombre de Subsección</label>
											<input type="text" class="form-control" name="Subseccion2" id="Subseccion2" placeholder="Ingrese Nombre" required="">
											<input type="hidden" class="form-control" name="Id_Subseccion" id="Id_Subseccion">
										</div>
										<div class="form-group">
											<label for="IdSeccion2">Sección</label>
											<select class="form-control select2" style="width: 100%;" required="" name="IdSeccion2" id="IdSeccion2">
												<option></option>
											</select>
										</div>
										<div class="form-group">
											<label for="Nota2">Nota</label>
											<input type="text" class="form-control" name="Nota2" id="Nota2" placeholder="Comentario">
										</div>
									</div>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		var listar=function(){
			var table = $('#example').DataTable({
				ajax: {
					url: '<?php echo base_url();?>Administrar/CargarTablaSubseccion',
					type: 'POST'
				},
		...
		var editar = function(tbody, table){
			$(tbody).on('click', 'button.editar', function() {
				...
				$('#Subseccion2').val(data.Subseccion);
				$('#Id_Subseccion').val(data.Id_Subseccion);
				$('#Nota2').val(data.Nota);

				$('#IdSeccion2').val(data.IdSeccion); // Select the option with a value of '1'
				$('#IdSeccion2').trigger('change'); // Notify any JS components that the value changed
			});
		}
